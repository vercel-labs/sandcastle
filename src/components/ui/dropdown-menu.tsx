...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-[9999] min-w-[8rem] overflow-hidden rounded-xl bg-background-100 p-1 text-gray-1000",
      "shadow-lg",
...
>(({ className, inset, prefix, suffix, children, ...props }, ref) => (
  ...
  >
    ...
    {children}
    {suffix && <span className="ml-auto inline-flex shrink-0 text-gray-700">{suffix}</span>}
  </DropdownMenuPrimitive.Item>
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-label-12 font-semibold",
      inset && "pl-8",
      className
    )}
    {...props}
